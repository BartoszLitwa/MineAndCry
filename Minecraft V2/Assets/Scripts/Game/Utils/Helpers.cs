...
public class Helpers
{
    ...
    public readonly static Vector3 toolbarScaleClosedSurivivalInevntory = new Vector3(2f, 2f, 1f);
    public readonly static Vector3 toolbarPosOpenedSurivivalInevntory = new Vector3(960, 396, 0);
    public readonly static Vector3 toolbarPosClosedSurivivalInevntory = new Vector3(960, 70, 0);
